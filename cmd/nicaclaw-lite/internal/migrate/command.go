...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from OpenClaw to nicaclaw-lite",
		Args:  cobra.NoArgs,
		Example: `  nicaclaw-lite migrate
  nicaclaw-lite migrate --dry-run
  nicaclaw-lite migrate --refresh
  nicaclaw-lite migrate --force`,
	...
	cmd.Flags().StringVar(&opts.NicaclawliteHome, "nicaclaw-lite-home", "",
		"Override nicaclaw-lite home directory (default: ~/.nicaclaw-lite)")
