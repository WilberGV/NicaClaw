...
// WeCom App (ä¼ä¸šå¾®ä¿¡è‡ªå»ºåº”ç”¨) channel implementation
...
// WeComAppChannel implements the Channel interface for WeCom App (ä¼ä¸šå¾®ä¿¡è‡ªå»ºåº”ç”¨)
...
func (c *WeComAppChannel) handleVerification(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// For WeCom App (è‡ªå»ºåº”ç”¨), receiveid should be corp_id
