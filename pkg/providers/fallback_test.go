...
func TestResolveCandidates_Simple(t *testing.T) {
	...
	candidates := ResolveCandidates(cfg.Primary, cfg.Fallbacks, "openai", func(string) int { return 0 })
	if len(candidates) != 3 {
...
func TestResolveCandidates_Deduplication(t *testing.T) {
	...
	candidates := ResolveCandidates(cfg.Primary, cfg.Fallbacks, "default", func(string) int { return 0 })
	if len(candidates) != 2 {
